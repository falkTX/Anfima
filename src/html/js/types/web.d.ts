...
export { MIDIAccess, MIDIConnectionEvent, MIDIInput, MIDIMessageEvent, MIDIOutput, MIDIPort }
...
export { HID, HIDConnectionEvent, HIDDevice, HIDInputReportEvent };
