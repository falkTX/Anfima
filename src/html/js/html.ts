    ...
    const htmlElements: HTMLElements = {
        ...
        pages: {
            ...
            fileManager: {
                ...
                addModal: getElementById('anfima-file-manager-add-modal') as HTMLFormElement,
            ...
            tools: {
                ...
                resetUserDataButton: getElementById('anfima-tools-reset-user-data') as HTMLButtonElement,
            },
        },
        reportModal: {
